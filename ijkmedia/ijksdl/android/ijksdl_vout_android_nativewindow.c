...
static int func_display_overlay_l(SDL_Vout *vout, SDL_VoutOverlay *overlay)
{
    ...
    // ALOGI("wqq-func_display_overlay_l");
    if (!native_window) {
    ...
    // ALOGI("wqq-overlay->format:%d AMC:%d, RV24:%d, I420:%d, YV12:%d, RV16:%d, RV32:%d. vout->overlay_format:%d, GLES2:%d",
    // overlay->format, SDL_FCC__AMC, SDL_FCC_RV24, SDL_FCC_I420, SDL_FCC_YV12, SDL_FCC_RV16, SDL_FCC_RV32, vout->overlay_format, SDL_FCC__GLES2);
