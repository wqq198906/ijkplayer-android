...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private native void _setVideoBitmap(Bitmap bitmap);

    private native void _setVideoRenderTime(int time);
    ...
    public void setVideoBitmap(Bitmap bitmap) {
        _setVideoBitmap(bitmap);
    }

    public void setVideoRenderTime(int time) {
        _setVideoRenderTime(time);
    }
